...
/**
 * Recharts 3 compatible tooltip.
 *
 * Recharts 3 no longer exposes payload/label through the
 * React.ComponentProps<typeof Tooltip> type, so we define
 * the additional properties explicitly.
 */
...
/**
 * Recharts 3 compatible legend payload.
 */
